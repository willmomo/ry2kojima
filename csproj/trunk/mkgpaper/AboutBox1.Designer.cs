namespace mkgpaper {
    partial class AboutBox1 {
        ...
        private void InitializeComponent() {
			...
			this.labelProductName.Text = "方眼紙印刷";
			...
			this.labelCopyright.Text = "Copyright (C) 2007";
			...
			this.textBoxDescription.Text = "方眼紙を印刷するプログラムです。\r\nハードマージンのチェックが、いい加減です。";
			// 
			// okButton
			// 
