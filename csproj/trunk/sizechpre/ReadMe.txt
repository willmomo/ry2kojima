========================================================================
    Win32 アプリケーション: sizechpre プロジェクトの概要
========================================================================

この sizechpre アプリケーションは、AppWizard により作成されました。
...
sizechpre.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル sizechpre.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル sizechpre.rc 
    にインクルードされます。
