========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : skeletonmfcdlg
========================================================================


AppWizard が生成した skeletonmfcdlg には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには skeletonmfcdlg を構成している各ファイルの概要説明が含まれています。
...
skeletonmfcdlg.h
    ...
    みます） をインクルードし、また CSkeletonmfcdlgApp アプリケーションクラスを宣
    言します。

skeletonmfcdlg.cpp
    このファイルは CSkeletonmfcdlgApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\skeletonmfcdlg.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイ
    ルです。このアイコンはリソース ファイル skeletonmfcdlg.rc によってインクルード
    されます。

res\skeletonmfcdlg.rc2
...
skeletonmfcdlgDlg.h, skeletonmfcdlgDlg.cpp - ダイアログ
    これらのファイルは CSkeletonmfcdlgDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な skeletonmfcdlg.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) skeletonmfcdlg.pch 
