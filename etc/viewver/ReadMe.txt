========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : viewver
========================================================================


AppWizard が生成した viewver には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには viewver を構成している各ファイルの概要説明が含まれています。
...
viewver.h
    ...
    みます） をインクルードし、また CViewverApp アプリケーションクラスを宣
    言します。

viewver.cpp
    このファイルは CViewverApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\viewver.ico
    ...
    ルです。このアイコンはリソース ファイル viewver.rc によってインクルード
    されます。
...
viewverDlg.h, viewverDlg.cpp - ダイアログ
    これらのファイルは CViewverDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な viewver.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) viewver.pch 
