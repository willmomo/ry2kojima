========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : OLEDT
========================================================================


AppWizard が生成した OLEDT には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには OLEDT を構成している各ファイルの概要説明が含まれています。
...
OLEDT.h
    ...
    みます） をインクルードし、また COLEDTApp アプリケーションクラスを宣
    言します。

OLEDT.cpp
    このファイルは COLEDTApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\OLEDT.ico
    ...
    ルです。このアイコンはリソース ファイル OLEDT.rc によってインクルード
    されます。
...
OLEDTDlg.h, OLEDTDlg.cpp - ダイアログ
    これらのファイルは COLEDTDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な OLEDT.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) OLEDT.pch 
