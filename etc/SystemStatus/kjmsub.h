...
namespace kjm {
	...
	public:
		...
		// コピーコンストラクタ
		file(const file& src) : m_fullPath(src.m_fullPath), m_lastWriteTime(src.m_lastWriteTime), m_fileSize(src.m_fileSize) {};
		...
		// ファイルの最終更新日時を返す
		dateTime getLastWriteTime() { return m_lastWriteTime; };
