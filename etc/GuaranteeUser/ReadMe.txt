========================================================================
    コンソール アプリケーション : GuaranteeUser プロジェクトの概要
========================================================================

AppWizard はユーザー用に GuaranteeUser アプリケーションを作成しました。  
このファイルには GuaranteeUser アプリケーションを構成している
各ファイルの概要が含まれています。


GuaranteeUser.vcproj
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済みヘッダー (PCH) ファイル GuaranteeUser.pch、
