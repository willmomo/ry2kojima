========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : keyhook_sample
========================================================================


AppWizard が生成した keyhook_sample には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには keyhook_sample を構成している各ファイルの概要説明が含まれています。
...
keyhook_sample.h
    ...
    みます） をインクルードし、また CKeyhookApp アプリケーションクラスを宣
    言します。

keyhook_sample.cpp
    このファイルは CKeyhookApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\keyhook_sample.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイ
    ルです。このアイコンはリソース ファイル keyhook_sample.rc によってインクルード
    されます。

res\keyhook_sample.rc2
...
keyhookDlg.h, keyhookDlg.cpp - ダイアログ
    これらのファイルは CKeyhookDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な keyhook_sample.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) keyhook_sample.pch 
