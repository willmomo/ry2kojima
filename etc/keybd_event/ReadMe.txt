========================================================================
       WIN32 アプリケーション : keybd_event
========================================================================


AppWizard はこの keybd_event アプリケーションを作成しました。  

このファイルには keybd_event アプリケーションを構成している各ファイルの概要
説明が含まれています。
...
res\keybd_event.ico
    ...
    このアイコンはリソース ファイル keybd_event.rc によってインクルードされます。
small.ico
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済みヘッダーファイル (PCH) keybd_event.pch
