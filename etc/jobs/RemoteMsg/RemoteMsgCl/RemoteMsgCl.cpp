// RemoteMsgCl.cpp : アプリケーション用のエントリ ポイントの定義
//
                     ...
                     int       nCmdShow )
{
	...
	LoadString(hInstance, IDC_REMOTEMSGCL, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, (LPCTSTR)IDC_REMOTEMSGCL);
...
ATOM MyRegisterClass( HINSTANCE hInstance )
{
	...
	wcex.hIcon		= LoadIcon(hInstance, (LPCTSTR)IDI_REMOTEMSGCL);
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= (LPCSTR)IDC_REMOTEMSGCL;
