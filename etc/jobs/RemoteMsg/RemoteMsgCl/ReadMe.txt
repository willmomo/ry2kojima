========================================================================
       WIN32 アプリケーション : RemoteMsgCl
========================================================================


AppWizard はこの RemoteMsgCl アプリケーションを作成しました。  

このファイルには RemoteMsgCl アプリケーションを構成している各ファイルの概要
説明が含まれています。
...
res\RemoteMsgCl.ico
    ...
    このアイコンはリソース ファイル RemoteMsgCl.rc によってインクルードされます。
small.ico
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済みヘッダーファイル (PCH) RemoteMsgCl.pch
