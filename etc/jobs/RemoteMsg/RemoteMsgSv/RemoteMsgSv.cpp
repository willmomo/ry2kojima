// RemoteMsgSv.cpp : アプリケーション用のエントリ ポイントの定義
//
                     ...
                     int       nCmdShow )
{
	...
	LoadString(hInstance, IDC_REMOTEMSGSV, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, (LPCTSTR)IDC_REMOTEMSGSV);
...
ATOM MyRegisterClass( HINSTANCE hInstance )
{
	...
	wcex.hIcon		= LoadIcon(hInstance, (LPCTSTR)IDI_REMOTEMSGSV);
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= (LPCSTR)IDC_REMOTEMSGSV;
...
{
	static remote_message_server s_server;
