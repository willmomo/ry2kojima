========================================================================
       WIN32 アプリケーション : RemoteMsgSv
========================================================================


AppWizard はこの RemoteMsgSv アプリケーションを作成しました。  

このファイルには RemoteMsgSv アプリケーションを構成している各ファイルの概要
説明が含まれています。
...
res\RemoteMsgSv.ico
    ...
    このアイコンはリソース ファイル RemoteMsgSv.rc によってインクルードされます。
small.ico
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済みヘッダーファイル (PCH) RemoteMsgSv.pch
