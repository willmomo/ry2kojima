...
void kjm::file::deleteFile(const _tstring& path, bool force) {
	...
	if (force) {
		kjm::file::setAttributes(path, (kjm::fileAttributes)(kjm::file::getAttributes(path) & ~kjm::fileAttributes::readOnly));
	}
...
// ファイルの属性を取得する。
//-----------------------------------------------------------------------------
kjm::fileAttributes kjm::file::getAttributes(const _tstring& path) {
	...
	return (kjm::fileAttributes)dwAttr;
}

//-----------------------------------------------------------------------------
// ファイルの属性を設定する。
//-----------------------------------------------------------------------------
void kjm::file::setAttributes(const _tstring& path, kjm::fileAttributes fa) {
