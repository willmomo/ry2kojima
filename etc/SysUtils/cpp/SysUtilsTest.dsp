# Microsoft Developer Studio Project File - Name="SysUtilsTest" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** 編集しないでください **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=SysUtilsTest - Win32 Debug
!MESSAGE これは有効なﾒｲｸﾌｧｲﾙではありません。 このﾌﾟﾛｼﾞｪｸﾄをﾋﾞﾙﾄﾞするためには NMAKE を使用してください。
!MESSAGE [ﾒｲｸﾌｧｲﾙのｴｸｽﾎﾟｰﾄ] ｺﾏﾝﾄﾞを使用して実行してください
!MESSAGE 
!MESSAGE NMAKE /f "SysUtilsTest.mak".
!MESSAGE 
!MESSAGE NMAKE の実行時に構成を指定できます
!MESSAGE ｺﾏﾝﾄﾞ ﾗｲﾝ上でﾏｸﾛの設定を定義します。例:
!MESSAGE 
!MESSAGE NMAKE /f "SysUtilsTest.mak" CFG="SysUtilsTest - Win32 Debug"
!MESSAGE 
!MESSAGE 選択可能なﾋﾞﾙﾄﾞ ﾓｰﾄﾞ:
!MESSAGE 
!MESSAGE "SysUtilsTest - Win32 Release" ("Win32 (x86) Application" 用)
!MESSAGE "SysUtilsTest - Win32 Debug" ("Win32 (x86) Application" 用)
!MESSAGE 
...
!IF  "$(CFG)" == "SysUtilsTest - Win32 Release"
...
!ELSEIF  "$(CFG)" == "SysUtilsTest - Win32 Debug"
...
# Name "SysUtilsTest - Win32 Release"
# Name "SysUtilsTest - Win32 Debug"
...
SOURCE=.\SysUtilsTest.cpp
# End Source File
# Begin Source File

SOURCE=.\SysUtilsTest.rc
# End Source File
# End Group
