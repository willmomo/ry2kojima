========================================================================
       WIN32 アプリケーション : SysUtilsTest
========================================================================


AppWizard はこの SysUtilsTest アプリケーションを作成しました。  

このファイルには SysUtilsTest アプリケーションを構成している各ファイルの概要
説明が含まれています。
...
res\SysUtilsTest.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイル(32x32) です。
    このアイコンはリソース ファイル SysUtilsTest.rc によってインクルードされます。
small.ico
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済みヘッダーファイル (PCH) SysUtilsTest.pch
