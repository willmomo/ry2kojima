...
Private Sub mnuEditJust_Click()
    ...
    Do Until curNode Is Nothing
        ...
        ''Picture1.Line (rcUnion.Left, rcUnion.Top)-(rcUnion.Right, rcUnion.Bottom), , B
    ...
    Picture1.Left = 0
    Picture1.Top = 0
    Picture1.Width = rcUnion.Right + (Screen.TwipsPerPixelX) + 10 * Screen.TwipsPerPixelX
    Picture1.Height = rcUnion.Bottom + (Screen.TwipsPerPixelY) + 10 * Screen.TwipsPerPixelY

    Debug.Print Now, rcUnion.Right, rcUnion.Bottom
