========================================================================
    Win32 アプリケーション: mute プロジェクトの概要
========================================================================

この mute アプリケーションは、AppWizard により作成されました。
...
mute.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル mute.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル mute.rc 
    にインクルードされます。
