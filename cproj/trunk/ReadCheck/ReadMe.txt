========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : ReadCheck
========================================================================


AppWizard が生成した ReadCheck には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには ReadCheck を構成している各ファイルの概要説明が含まれています。
...
ReadCheck.h
    ...
    みます） をインクルードし、また CReadCheckApp アプリケーションクラスを宣
    言します。

ReadCheck.cpp
    このファイルは CReadCheckApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\ReadCheck.ico
    ...
    ルです。このアイコンはリソース ファイル ReadCheck.rc によってインクルード
    されます。
...
ReadCheckDlg.h, ReadCheckDlg.cpp - ダイアログ
    これらのファイルは CReadCheckDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な ReadCheck.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) ReadCheck.pch 
