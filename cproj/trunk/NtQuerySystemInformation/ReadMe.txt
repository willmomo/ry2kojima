========================================================================
    コンソール アプリケーション: NtQuerySystemInformation プロジェクトの概要
========================================================================

この NtQuerySystemInformation アプリケーションは、AppWizard により作成されました。

このファイルには、NtQuerySystemInformation 
...
NtQuerySystemInformation.vcxproj.filters
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、NtQuerySystemInformation.pch 
